# Script:  mkinput_lamellae_50%tap.py
...
# Syntax: "python mkinput_lamellae_50%tap.py"
...
percentTaper = 50./100.                       # tapered midblock length in percent
...
# files
INPUT_LAMMPS = open('input_50tap.lammps', 'w')
