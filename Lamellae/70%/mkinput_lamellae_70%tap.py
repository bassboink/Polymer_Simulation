# Script:  mkinput_lamellae_70%tap.py
...
# Syntax: "python mkinput_lamellae_70%tap.py"
...
percentTaper = 70./100.                       # tapered midblock length in percent
...
# Define monomer sequence: tapered diblock copolymers
...
# files
INPUT_LAMMPS = open('input_70tap.lammps', 'w')
